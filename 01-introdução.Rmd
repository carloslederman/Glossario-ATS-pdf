...
knitr::include_graphics("capa11.png")
```

******


A Rede Internacional de Agências para a Avaliação de Tecnologias em Saúde (INAHTA^1^, The International Network of Agencies for Health Technology Assessment) é uma organização sem fins lucrativos formada por instituições 
...
A INAHTA mantém um Glossário^2^ de termos técnicos em ATS e os apresenta em quatro idiomas: Inglês, Espanhol, Francês e Alemão. 
...
A tradução foi feita por Carlos Lederman^3^ e Wanderley Marques Bernardo^4^,  e revista pelos seguintes alunos de Medicina do Centro Universitário Lusíada (UNILUS):
